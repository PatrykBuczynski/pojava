package pw.java.wyk6.watkiSwing;
...
public class SwingWorkerCopyFiles extends JFrame{
    ...
    class CopySwingWorker extends SwingWorker<Void, Void>{
        ...
        public CopySwingWorker(File from, File to) {
            ...
            //PropertyChangeListener pozwala na wyswietlenie postepu kopiowania plików
        ...
        //Metoda uruchamiana w tle, w trakcie jej wykonania ramka jest responsywna.
        @Override
        protected Void doInBackground() throws Exception {
            ...
            try{
                while (read != -1){ // read() zwroci -1 jesli plik sie skonczyl
                    ...
                    readBytes++;
                    if (readBytes%100000==0){ // Odswiezamy wynik co ok 0.1mb inaczej byloby nieefektywnie
                        // Pozwala na ustawienie progress baru który podaje postęp od 0 do 100
